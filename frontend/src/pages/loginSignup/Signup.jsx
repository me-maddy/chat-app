...
const Signup = () => {
  ...
  return (
    <div className="mt-16 flex items-center justify-center">
      <div className="max-w-lg bg-amber-50 min-w-2xs sm:min-w-md md:min-w-lg p-4 sm:p-8 rounded shadow-[0px_0px_6px] shadow-amber-200">
